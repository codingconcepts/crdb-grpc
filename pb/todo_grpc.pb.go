...
func (c *todoServiceClient) GetTodos(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetTodosResponse, error) {
...
func (UnimplementedTodoServiceServer) GetTodos(context.Context, *Empty) (*GetTodosResponse, error) {
